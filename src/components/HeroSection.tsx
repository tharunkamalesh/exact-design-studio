  ...
  return (
    <section id="home" className="relative h-screen overflow-hidden">
      ...
      <nav className="absolute top-0 left-0 right-0 z-30 bg-transparent pt-6">
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-between">
              ...
              {navLinks.map((link) => (
                <li key={link.name}>
                  <a
                    ...
                    className={`text-white text-sm font-normal transition-all hover:opacity-80 ${activeLink === link.name ? 'border-b border-white pb-1' : ''
                      }`}
                  >
                    {link.name}
                  </a>
            ...
            <a
              href="#contact"
              className="hidden md:inline-block px-6 py-2 border border-white text-white rounded-full text-sm font-normal transition-all hover:bg-white hover:text-gray-900"
            >
              Contact Us
            </a>
      ...
      <div className="relative z-20 flex h-full items-center">
        <div className="container mx-auto px-6 py-20">
          <div className="max-w-2xl ml-auto mr-0 text-right">
            ...
            <h1
              className="text-white mb-6 uppercase opacity-0 translate-y-10"
              id="main-heading"
              ref={headingRef}
            >
              KING POWER SYSTEMS
            ...
            <p
              className="text-white mb-4 opacity-0 translate-y-10"
              style={{ opacity: '1' }}
              id="subtext-1"
              ref={subtext1Ref}
            >
            ...
            <p
              className="text-white opacity-0 translate-y-10"
              style={{ opacity: '1' }}
              id="subtext-2"
              ref={subtext2Ref}
            >
      ...
      <div className="absolute bottom-0 left-0 right-0 overflow-hidden z-10">
        <h2 className="font-bold text-[8vw] md:text-[12vw] tracking-tight text-white whitespace-nowrap"
          style={{ opacity: '0.15' }}>
          SOLAR ENERGY
        </h2>
      </div>
